/* @pjs preload="circle-32.png, circle-xxl.png, default.gif, default.png, neutron.gif, neutron0.png, neutron1.png, neutron2.png, neutron3.png, neutron4.png, proton.gif, proton0.png, proton1.png, proton2.png, proton3.png, proton4.png"; 
 */
...
void draw () {
  ...
  if (millis()>doomTime +1000 && doomed.size()>0){  // Time's up
    doomed.get(i).velocity.add(doomed.get(i).position.mult(0.1));
  }
  ...
  if (atomicNumber!=oldAtomicNumber||neutrons!=oldNeutrons) { // New nuclide time
    ...
    println("Doom will be in "+(doomTime-millis())+" milliseconds");
    println("millis now="+millis());
    doomed.clear();
