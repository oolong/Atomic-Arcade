...
public void loadData() {
  if (java) {
    ...
    for (int i=0; i<nuclides.getRowCount(); i++) {
      ...
      float halfLife=0.1f*log(nuclides.getFloat(i, 2)); // We're taking the natural logarithm of the real halflife to bring things into human timescales

      if (halfLife<0.1f) halfLife=1;
